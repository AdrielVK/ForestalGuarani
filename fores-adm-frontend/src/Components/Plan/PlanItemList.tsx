...
const PlanListItem = (data:Plan) => {
  ...
  return (
    <div className="bg-white  border-2 border-lime-300 cursor-pointer shadow-sm rounded-lg p-4 mb-4 hover:border-lime-400 hover:bg-gray-100 transition-bg transition-border duration-300">
